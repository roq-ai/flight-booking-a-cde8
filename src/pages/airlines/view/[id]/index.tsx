...
import { useAirlineFindFirst, useRoqClient } from 'lib/roq';
...
function AirlineViewPage() {
  ...
  const { data, error, isLoading } = useAirlineFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('airline', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/airlines/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="airline" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
