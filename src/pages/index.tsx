  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Flight Booking Application: Choose your preferred flight, secure your fares from surges, book your ticket at ₹0, and pay later. Experience convenience like never before with Code XYZH."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmbGlnaHR8ZW58MHx8fHwxNjk3NDU0NzU0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rparmly?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Ross Parmly`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Flight Booking Application: Choose your preferred flight, secure your fares from surges, book your ticket at ₹0, and pay later. Experience convenience like never before with Code XYZH.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Sales Manager" type="sales-manager" abilities={appConfig.ownerAbilities} />
